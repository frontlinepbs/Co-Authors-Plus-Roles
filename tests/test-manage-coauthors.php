<?php
/**
 * Test Co-Authors Plus' functions for querying authors/posts
 *
 * Run to make sure nothing in this plugin breaks any of
 * the existing functionality from Co-Authors Plus.
 *
 */

class Test_Manage_CoAuthors extends CoAuthorsPlusRoles_TestCase {
